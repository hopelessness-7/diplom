<x-jet-form-section submit="updateProfileInformation">
    ...
    <x-slot name="form">
        ...
        <div class="col-span-6 sm:col-span-4">
            <x-jet-label for="first_name" value="{{ __('Имя') }}" />
        ...
        <!-- last_name -->
        <div class="col-span-6 sm:col-span-4">
            <x-jet-label for="last_name" value="{{ __('Фамилия') }}" />
        ...
        <!-- document_number -->
        <div class="col-span-6 sm:col-span-4">
            <x-jet-label for="document_number" value="{{ __('Документ') }}" />
            <x-jet-input id="document_number" type="text" class="mt-1 block w-full" wire:model.defer="state.document_number" autocomplete="document_number" />
